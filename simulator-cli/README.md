...
* Go to cli directory
* Add executable privilege to nf_simulator.py and netconf_simulator.py (for example `chmod +x <path_to_nf_simulator.py>`)

### Development and testing
To run unit tests for NF and Netconf simulators cli execute `tox`.
...
Example:
`
netconf_simulator.py get-config --address localhost --module-name nf-simulator --container config
`
